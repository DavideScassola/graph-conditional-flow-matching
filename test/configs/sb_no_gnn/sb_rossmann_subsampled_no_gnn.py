...
DATA_PATH = "syntherela_benchmark/data/original/rossmann_subsampled"
...
LR_SCHEDULER_PARAMETERS = {"lr_lambda": partial(exponential_decaying_lr, start_lr=LR_INITIAL, final_lr=1e-5, n_epochs=EPOCHS)}
...
hidden_channels_dict = {
    'store': (200, 200),
    'historical': (600, 600, 600),
}
